...
- (OrdinateView*)ordinateView {
    if (!_ordinateView) {
        _ordinateView = [[OrdinateView alloc]
                         initWithFrame:CGRectMake(0, 0, 0, self.frame.size.height)
                         topNumber:self.top
...
- (XLineChartView*)lineChartView {
    if (!_lineChartView) {
        float ordinateViewWidth = self.ordinateView.frame.size.width;
        _lineChartView = [[XLineChartView alloc]
                          initWithFrame:CGRectMake(
                                                   ordinateViewWidth, LineChartViewTopInterval,
                                                   self.frame.size.width - ordinateViewWidth,
